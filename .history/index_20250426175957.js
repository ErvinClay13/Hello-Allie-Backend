...
// --- NBA Schedule API (Logging version) ---
...
const fetchNBASchedule = async (date) => {
  try {
    ...
    console.log("🏀 FULL NBA API Raw Response:", JSON.stringify(response.data, null, 2)); // LOG the full response

    return "Logged NBA API response. Check server logs.";
  } catch (error) {
