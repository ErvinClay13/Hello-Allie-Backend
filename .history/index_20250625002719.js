// Updated full backend with smart AI features, NBA scores, weather, time, jokes, and personality
...
app.post("/api/smart", async (req, res) => {
  ...
  try {
    ...
    const wrapper = personalityPrompts[personality?.toLowerCase()] || personalityPrompts.friendly;
